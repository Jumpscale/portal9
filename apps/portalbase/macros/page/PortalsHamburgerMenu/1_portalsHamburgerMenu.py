...
def main(j, args, params, tags, tasklet):
    ...
    groups = j.portal.server.active.getGroupsFromCTX(args.requestContext)
    for portal in menulinks[:]:
        ...
        if external != 'true':
            ...
            if spacename in j.portal.server.active.spacesloader.spaces:
                space = j.portal.server.active.spacesloader.spaces[spacename]
    ...
    hrdListHTML = j.portal.server.active.templates.render('system/hamburgermenu/structure.html', menulinks=menulinks)
    script = j.portal.server.active.templates.render('system/hamburgermenu/script.js')
    style = j.portal.server.active.templates.render('system/hamburgermenu/style.css')
